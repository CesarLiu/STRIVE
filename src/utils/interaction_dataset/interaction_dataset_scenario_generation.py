...
from utils.interaction_dataset.interaction_dataset_reader import InteractionDatasetReader
...
class InteractionDatasetScenarioGeneration(ScenarioGeneration):
    ...
    def initialize_params(self, params):
        ...
        Attention: This scenario geneartion can only generate one scenario at a time as mentioned here: replay mode.
    ...
    def __create_single_scenario__(self, scenario_track_info):
        print('Creating single scenario...')
